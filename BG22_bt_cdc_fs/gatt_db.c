...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_18 ) = {
	.len=19,
	.data={0x14,0x14,0x00,0xd6,0x58,0xd6,0x21,0xbc,0x55,0x81,0x9f,0x42,0x44,0x71,0x6d,0xc4,0x6e,0xc2,0xfe,}
};
uint8_t bg_gattdb_data_attribute_field_17_data[1]={0x30,};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_16 ) = {
	.len=19,
	.data={0x0a,0x12,0x00,0x68,0x60,0x95,0x48,0xd6,0x07,0x87,0xa7,0xcd,0x4d,0x47,0x5f,0x57,0x77,0xcd,0x56,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_14 ) = {
	.len=19,
	.data={0x02,0x10,0x00,0x21,0xb7,0xed,0x25,0xd1,0x55,0x43,0x93,0xed,0x45,0xff,0x14,0xd2,0xd3,0x2b,0x29,}
};
...
uint8_t bg_gattdb_data_attribute_field_10_data[8]={0x4e,0x49,0x53,0x54,0x2d,0x47,0x45,0x4e,};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_data_attributes_map[])={
    ...
    {.uuid=0x8002,.permissions=0x803,.caps=0xffff,.datatype=0x01,.dynamicdata=&bg_gattdb_data_attribute_field_17},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_18},
    {.uuid=0x8003,.permissions=0x804,.caps=0xffff,.datatype=0x02,.dynamicdata=&bg_gattdb_data_attribute_field_19},
    ...
    {.uuid=0x0007,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_23},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_24},
    {.uuid=0x0008,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_25},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_26},
    {.uuid=0x0009,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_27},
